...
@Component({
  selector: 'app-manger-of-tech',
  templateUrl: './manger-of-tech.component.html',
  styleUrls: ['./manger-of-tech.component.css']
})
export class MangerOfTechComponent implements OnInit {
