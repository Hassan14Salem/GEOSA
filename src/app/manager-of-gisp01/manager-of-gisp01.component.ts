...
@Component({
  selector: 'app-manager-of-gisp01',
  templateUrl: './manager-of-gisp01.component.html',
  styleUrls: ['./manager-of-gisp01.component.css']
})
export class ManagerOfGISP01Component implements OnInit {
